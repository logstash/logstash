...
| The escape sequences in strings are not processed by default (`disabled`/`false`).
  ...
  When set to `extended`, quoted strings will process everything in `minimal`, plus `\0` becomes a literal NULL (ASCII 0), `\xHH` becomes the corresponding hexadecimal codepoint (`\0x24` -> `$` ), and `\uHHHH` or `\uHHHHHHHH` become the corresponding unicode codepoint (`\u267B` -> &#x267B; ; `\u0001F49E` -> &#128158;).
| `false`
